...
import { MdEmail, MdPhone, MdLockOutline, MdPerson } from "react-icons/md";
...
export default function Signup() {
    ...
    const isValid =
        method === "phone"
            ...
            : email.includes("@") && password.length >= 6 && name.length > 2;

    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-green-50 flex flex-col">
            {/* Scrollable container for mobile */}
            <div className="flex-1 flex items-center justify-center px-4 py-8 overflow-y-auto">
                <div className="w-full max-w-4xl bg-white rounded-3xl shadow-2xl overflow-hidden grid md:grid-cols-2 max-h-screen md:max-h-none">
                    {/* LEFT: Branding */}
